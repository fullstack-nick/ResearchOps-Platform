...
const styles: Record<string, string> = {
  ...
  extraction_failed: 'border-red-200 bg-red-50 text-red-800',
  pending: 'border-violet-200 bg-violet-50 text-violet-800',
  processing: 'border-blue-200 bg-blue-50 text-blue-800',
  extracting: 'border-blue-200 bg-blue-50 text-blue-800',
  extraction_pending: 'border-violet-200 bg-violet-50 text-violet-800',
};
